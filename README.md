...
Please visit [ThisseasX](https://thisseasx.github.io/thisseasx-cv) to view my CV.
...
![Performance](samples/performance.png)
![Score](samples/overall-score.png)
![Metrics](samples/metrics.png)

## 📱Social Media Preview

Thanks to Open Graph Protocol tags

![alt text](samples/og-preview.png)
